...
import PageObject.How_To_Wash_ClothesPage;
import ResuableComponenet.BaseClass;
import Utilities.log;

public class How_To_Wash_ClothesTestRunner extends BaseClass {
...
//		driver.get("https://tide.com/en-us");
		...
		How_To_Wash_ClothesPage lo = new How_To_Wash_ClothesPage(driver);
		lo.Wash();
	//	driver.close();
